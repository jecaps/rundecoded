...
export const catalogueCopy = {
  en: {
    ...
    selectProduct: (model: string) => `Add ${model} to comparison`,
    deselectProduct: (model: string) => `Deselect ${model}`,
    compareSelected: (count: number) => `Compare (${count}/2)`,
    previous: 'Previous',
    next: 'Next',
  ...
  de: {
    ...
    selectProduct: (model: string) => `${model} zum Vergleich hinzufügen`,
    deselectProduct: (model: string) => `${model} abwählen`,
    compareSelected: (count: number) => `Vergleichen (${count}/2)`,
    previous: 'Zurück',
    next: 'Weiter',
  ...
  fr: {
    ...
    selectProduct: (model: string) => `Ajouter ${model} à la comparaison`,
    deselectProduct: (model: string) => `Désélectionner ${model}`,
    compareSelected: (count: number) => `Comparer (${count}/2)`,
    previous: 'Précédent',
    next: 'Suivant',
